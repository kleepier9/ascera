...
export function ValueProps() {
  return (
    <section className="border-y border-border bg-card">
      <div className="mx-auto grid max-w-7xl grid-cols-2 gap-x-6 gap-y-8 px-4 py-12 sm:px-6 lg:grid-cols-4 lg:px-8">
        {valueProps.map((prop, i) => {
          const Icon = icons[i]
          return (
            <div key={prop.title} className="flex flex-col gap-2">
              <span className="grid size-10 place-items-center text-foreground">
